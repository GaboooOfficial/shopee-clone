...
router.patch('/:id/cancel', protect, roleCheck(['customer']), orderController.cancelOrder);
router.patch('/:id/address', protect, roleCheck(['customer']), orderController.updateShippingAddress);
