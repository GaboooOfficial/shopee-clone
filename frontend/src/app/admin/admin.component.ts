...
export class AdminComponent implements OnInit {
  ...
  loadPendingStores() {
    this.http
      .get<any>(`${this.baseUrl}/admin/stores/pending`, {
        headers: this.authService.getAuthHeaders(),
      })
      .subscribe({
        next: (res) => {
        ...
        error: (err) =>
          (this.errorMessage =
            err.error?.message || 'Failed to load pending stores'),
      });
  }

  loadAllStores() {
    this.http
      .get<any>(`${this.baseUrl}/admin/stores`, {
        headers: this.authService.getAuthHeaders(),
      })
      .subscribe({
        next: (res) => {
        ...
        error: (err) =>
          (this.errorMessage = err.error?.message || 'Failed to load stores'),
      });
  }
  ...
  approveStore(storeId: string) {
    this.http
      .patch<any>(
        `${this.baseUrl}/admin/stores/${storeId}/approve`,
        {},
        { headers: this.authService.getAuthHeaders() },
      )
      .subscribe({
        ...
        error: (err) =>
          (this.errorMessage = err.error?.message || 'Failed to approve store'),
      });
  }
  ...
  rejectStore(storeId: string) {
    this.http
      .patch<any>(
        `${this.baseUrl}/admin/stores/${storeId}/reject`,
        {},
        { headers: this.authService.getAuthHeaders() },
      )
      .subscribe({
        ...
        error: (err) =>
          (this.errorMessage = err.error?.message || 'Failed to reject store'),
      });
  }
  ...
  toggleStoreActive(storeId: string) {
    this.http
      .patch<any>(
        `${this.baseUrl}/admin/stores/${storeId}/toggle-active`,
        {},
        { headers: this.authService.getAuthHeaders() },
      )
      .subscribe({
        ...
        error: (err) =>
          (this.errorMessage =
            err.error?.message || 'Failed to toggle store activity'),
      });
  }
  ...
  loadUsers() {
    this.http
      ...
      .subscribe({
        ...
        error: (err) =>
          (this.errorMessage =
            err.error?.message || 'Failed to load user accounts'),
      });
  }
  ...
  toggleUserActive(userId: string) {
    this.http
      ...
      .subscribe({
        ...
        error: (err) =>
          (this.errorMessage =
            err.error?.message || 'Failed to toggle account activity'),
      });
  }
  ...
  createCategory() {
    this.http
      .post<any>(`${this.baseUrl}/categories`, this.newCategory, {
        headers: this.authService.getAuthHeaders(),
      })
      .subscribe({
        next: (res) => {
